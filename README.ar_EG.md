...
- **Subconverter** — محوّل اشتراكات Mihomo أضافه هذا الفورك، مع اختيار الاتصالات الواردة/العملاء، وحدود IP، وتصفية User-Agent، وسجلات الوصول. يدعم حاليًا فقط **VLESS + XHTTP + REALITY** و **VLESS + TCP + REALITY** و **VLESS + XHTTP + CDN TLS**؛ ولا تُدعم البروتوكولات أو طرق النقل أو أوضاع الأمان الأخرى.

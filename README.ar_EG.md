...
- **Subconverter** — محوّل اشتراكات Mihomo أضافه هذا الفورك، مع اختيار الاتصالات الواردة/العملاء، وحدود IP، وتصفية User-Agent، وسجلات الوصول. يدعم حاليًا فقط **VLESS + TCP + REALITY** و **VLESS + XHTTP + REALITY** و **VLESS + XHTTP + TLS** و **VLESS + XHTTP** و **VLESS + XHTTP + CDN TLS**؛ ولا تُدعم البروتوكولات أو طرق النقل أو أوضاع الأمان الأخرى.
...
لتثبيت إصدار محدد، أضِف وسمه (مثل `v3.8.5`):
...
للحصول على الوثائق الكاملة، يرجى زيارة [ويكي المشروع](https://github.com/zenvor/3x-ui/wiki).

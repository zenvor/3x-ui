...
update_menu() {
    ...
    if replace_xui_script "https://raw.githubusercontent.com/zenvor/3x-ui/main/x-ui.sh" "false"; then
...
update_shell() {
    if replace_xui_script "https://github.com/zenvor/3x-ui/raw/main/x-ui.sh" "true"; then

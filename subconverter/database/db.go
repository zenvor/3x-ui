...
//
// The subconverter module persists into data/subconverter.db (under the same
// folder as 3X-UI's main db). Keeping the file separate means upstream merges
// never touch our schema and 3X-UI's getDb/importDB cannot accidentally
// overwrite or leak our data.
package database

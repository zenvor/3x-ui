...
- **Subconverter** — conversor de suscripciones Mihomo añadido por este fork, con selección de entradas/clientes, límites de IP, filtrado de User-Agent y registros de acceso.
...
Para la documentación completa, visita la [Wiki del proyecto](https://github.com/zenvor/3x-ui/wiki).
